...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='customuser',
            name='correoUNI',
            field=models.EmailField(blank=True, max_length=50, null=True, unique=True, validators=[pfimapp.validators.validate_min_length_correo]),
        ),
        migrations.AlterField(
            model_name='customuser',
            name='email',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(error_messages={'unique': 'Este DNI ya está en uso.'}, max_length=12, unique=True, validators=[pfimapp.validators.validate_min_numeric_length]),
        ),
        migrations.AlterField(
            model_name='customuser',
